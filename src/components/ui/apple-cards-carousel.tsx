...
import { useOutsideClick } from '../hooks/apple-cards-carousel'
        ...
        {open && (
          <div className='fixed inset-0 h-screen z-50 overflow-auto'>
            ...
            <motion.div
              ...
              className='max-w-5xl mx-auto bg-teal-50 dark:bg-neutral-900 h-fit  z-[60] my-10 p-4 md:p-10 rounded-3xl font-roboto relative'
            >
              <button
