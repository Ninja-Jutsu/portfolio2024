...
const Hero = () => {
  return (
    <section className='py-10 sm:py-24 font-poppins h-[60vh]'>
      <div className='align-element grid  md:grid-cols-2 items-center gap-8 pl-2'>
        <article className='z-10 text-white'>
          <h1 className='text-5xl sm:text-7xl font-bold tracking-wider'>Hi, I am Ismail</h1>
          ...
          <div className='flex gap-x-4 mt-10 justify-center'>
            <a
              ...
              target='_blank'
            >
              <FaGithubSquare className='h-10 w-10 text-white hover:text-black duration-300' />
            </a>
            <a
              href='https://www.linkedin.com/in/ismail-bardach-83921a190/'
              target='_blank'
            >
              <FaLinkedin className='h-10 w-10 text-white hover:text-blue-500 duration-300' />
            </a>
            <a
              href='https://www.instagram.com/ismail__bardach/'
              target='_blank'
            >
              <FaInstagram className='h-10 w-10 text-white hover:text-red-500 duration-300' />
            </a>
          </div>
        </article>
